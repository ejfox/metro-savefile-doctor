...
const cli = meow(
	...
	Examples
	  $ savefile-doctor my-save.json
	  $ savefile-doctor my-save.json --script scripts/give-money.js
	  $ savefile-doctor my-save.json --script scripts/stats-report.lua
	  $ savefile-doctor --validate my-script.js
	  $ savefile-doctor my-save.json --output modified-save.json
	  $ savefile-doctor my-save.json --no-backup
`,
    {
