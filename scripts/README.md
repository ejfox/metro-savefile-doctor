...
```bash
savefile-doctor my-save.json --script scripts/give-money.js
# or
savefile-doctor my-save.json --script scripts/give-money.lua
```
...
```bash
savefile-doctor my-save.json --script scripts/fast-forward-time.js
```
...
```bash
savefile-doctor my-save.json --script scripts/give-trains.js
```
...
```bash
savefile-doctor my-save.json --script scripts/change-difficulty.js
```
...
```bash
savefile-doctor my-save.json --script scripts/stats-report.js
```
...
// ... and more (see MODDING.md for complete structure)
```
...
```bash
savefile-doctor my-save.json --script my-script.js
```
...
See the main MODDING.md for complete save file structure documentation.
